...
interface DuckDuckGoWebSearchArgs {
  query: string;
  count?: number;
}

function isDuckDuckGoWebSearchArgs(args: unknown): args is DuckDuckGoWebSearchArgs {
  return (
    typeof args === "object" &&
    args !== null &&
    "query" in args &&
    typeof (args as DuckDuckGoWebSearchArgs).query === "string"
  );
}
